...
import { Linkedin, Github, Instagram, Mail, MapPin, ArrowUp, ShieldCheck } from "lucide-react";
...
export function Footer() {
  ...
  return (
    <footer className="bg-logo-navy text-white pt-16 pb-12 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          {/* Col 1 & 2: Branding & Affiliation */}
          <div className="lg:col-span-2 space-y-4">
            <div className="flex items-center gap-2.5">
              <CearLogo className="w-10 h-10 border border-slate-700 shadow-sm" size={40} />
              <div>
